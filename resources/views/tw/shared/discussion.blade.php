    ...
    <div class="flex items-start md:mx-4">
        ...
        <div class="bg-gray-100 mt-3 p-3 rounded w-full">
            <div class="">
                ...
                <div class="text-gray-700" id="post-content-{{$post->id}}">
                    <p class="">
                ...
                <form action="{{route('posts.update', ['post' => $post])}}" method="POST" id="post-form-{{$post->id}}" class="hidden">
                    ...
                    <div>
                        <button class="btn btn-default bg-red-500 text-white" type="button" onclick="toggleEdit({{$post->id}})">cancel</button>
        ...
        <div class="mt-4 w-full">
            <form action="{{route('posts.store')}}" method="POST" id="post-form">
                ...
                <div class="form-group">
                    ...
                    <input type="hidden" name="back_url" value="{{$back_url}}">
                    <textarea placeholder="Comenta aqui" class=" w-full border border-gray-200 active:outline-none focus:outline-none focus:shadow-outline-blue p-3 rounded" name="content" id="post-content" value="{{old('content')}}"></textarea>
